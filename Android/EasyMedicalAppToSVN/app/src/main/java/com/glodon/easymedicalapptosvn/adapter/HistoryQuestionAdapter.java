 ...
 */
public class HistoryQuestionAdapter extends BasisAdapter<QuestionList> {

    private Context context;
    private LayoutInflater mInflater = null;
    private ImageLoader imageLoader;

    public HistoryQuestionAdapter(Context context, List<QuestionList> list) {
        super(context, list);
        this.mList = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            convertView = mInflater.inflate(R.layout.historyquestionitem_layout, null);
