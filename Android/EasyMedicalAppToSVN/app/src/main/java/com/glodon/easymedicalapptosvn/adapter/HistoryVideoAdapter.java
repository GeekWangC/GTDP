 ...
 */
public class HistoryVideoAdapter extends BasisAdapter<VideoList> {

    private Context context;
    private LayoutInflater mInflater = null;
    private ImageLoader imageLoader;

    public HistoryVideoAdapter(Context context, List<VideoList> list) {
        super(context, list);
        this.mList = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            convertView = mInflater.inflate(R.layout.historyvideoitem_layout, null);
