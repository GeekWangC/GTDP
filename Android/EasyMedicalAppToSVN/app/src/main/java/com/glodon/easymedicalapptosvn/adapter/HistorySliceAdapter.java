 ...
 */
public class HistorySliceAdapter extends BasisAdapter<SliceList> {

    private Context context;
    private LayoutInflater mInflater = null;
    private ImageLoader imageLoader;

    public HistorySliceAdapter(Context context, List<SliceList> list) {
        super(context, list);
        this.mList = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            convertView = mInflater.inflate(R.layout.historysliceitem_layout, null);
        ...
        mHolder.mCoursewareCountTv.setText("课件数量："+ String.valueOf(mList.get(position).getPicsNum()));
        //mHolder.mAllAntegralTv.setText(String.valueOf(mList.get(position).getTotalScore()));
