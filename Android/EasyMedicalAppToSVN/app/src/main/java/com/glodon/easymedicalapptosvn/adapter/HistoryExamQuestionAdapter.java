 ...
 */
public class HistoryExamQuestionAdapter extends BasisAdapter<ExamQuestionList> {

    private Context context;
    private LayoutInflater mInflater = null;
    private ImageLoader imageLoader;

    public HistoryExamQuestionAdapter(Context context, List<ExamQuestionList> list) {
        super(context, list);
        this.mList = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            convertView = mInflater.inflate(R.layout.historyexamquestionitem_layout, null);
       ...
       /* if(!StringTools.isEmpty(mList.get(position).getThumbnailUrl())){
        ...
        mHolder.mCoursenNameTv.setText(mList.get(position).getContent());
        //mHolder.mLecturerNameTv.setText(mList.get(position).getTeacher());
        //mHolder.mCoursewareCountTv.setText(String.valueOf(mList.get(position).getTotalPage()));
        mHolder.mAllAntegralTv.setText("总积分"+ String.valueOf(mList.get(position).getScore()));
