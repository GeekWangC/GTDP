 ...
 */
public class HistoryCourseAdapter extends BasisAdapter<CourseWareList> {

    private Context context;
    private LayoutInflater mInflater = null;
    private ImageLoader imageLoader;

    public HistoryCourseAdapter(Context context, List<CourseWareList> list) {
        super(context, list);
        this.mList = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            convertView = mInflater.inflate(R.layout.historycourseitem_layout, null);
        ...
        mHolder.mCoursewareCountTv.setText("课件数量："+ String.valueOf(mList.get(position).getTotalPage()));
